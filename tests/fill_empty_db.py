...
logger = logging.getLogger('fill_empty_db')
...
products = [
    SProductAdd(
        ...
        model = "Galaxy S21",
        is_purchased = True,
        buy_date = datetime.strptime("2022-03-15", '%Y-%m-%d'),
        guarantee = 24,
    ...
    SProductAdd(
        ...
        is_purchased = True,
        buy_date = datetime.strptime("2023-01-10", '%Y-%m-%d'),
        guarantee = 12,
    ...
    SProductAdd(
        ...
        model = "JBL Charge 4",
        is_purchased = True,
        buy_date = datetime.strptime("2021-08-05", '%Y-%m-%d'),
        guarantee = 12,
    ...
    SProductAdd(
        ...
        model = "Canon EOS R",
        is_purchased = True,
        buy_date = datetime.strptime("2022-11-22", '%Y-%m-%d'),
        guarantee = 24,
    ...
    SProductAdd(
        ...
        is_purchased = True,
        buy_date = datetime.strptime("2023-02-15", '%Y-%m-%d'),
        guarantee = 12,
    ...
    SProductAdd(
        ...
        model = "iPad Pro 11",
        is_purchased = True,
        buy_date = datetime.strptime("2023-06-12", '%Y-%m-%d'),
        guarantee = 12,
    ...
    SProductAdd(
        ...
        is_purchased = True,
        buy_date = datetime.strptime("2022-09-30", '%Y-%m-%d'),
        guarantee = 24,
    ...
    SProductAdd(
        ...
        is_purchased = True,
        buy_date = datetime.strptime("2023-04-01", '%Y-%m-%d'),
        guarantee = 12,
